...
async function memeThrower97(type, trigger){
    ...
    if (type == 'img'){
        ...
        newMeme = createImg('' + window.location.hostname + '/assets/img/memes/' + trigger + '/' + trigger + '_' + memeChoice + '.png');
        
    }
    else if (type == 'gif'){
        titleText = createDiv('' + trigger.toUpperCase() + '_' + memeChoice + ".GIF");
        newMeme = createImg('' + window.location.hostname + '/assets/gifs/' + trigger + '/' + trigger + '_' + memeChoice + '.gif');
    }
